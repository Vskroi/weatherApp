...
function App() {
  ...
  const getAllData = async () => {
    ...
    const icons = {
    clouds:'Clouds.png',
    cloudsmoon: 'Cloudsmoon.png',
    moon:'moon.png',
    sun:'sun.png',
    rain:'Rain.png',
    rainMoon:'Rainmoon.png',
    snow:'Snow.png',
    swnowTunderMoon:'snowTunder.moon.png',
    wind:'Wind.png',
    Wind:'WindMoon.png'
  };
      ...
      <div className="flex justify-center item-center relative top-[120px]">
        <div className="w-[800px] h-[1200px] relative absolute bg-gray-100 rounded-tl-[50px] rounded-bl-[50px] flex-col justify-start items-start inline-flex overflow-hidden">
          <div className="w-[1740px] h-[1740px] relative">
            ...
            <div className="w-[140px] h-[140px] opacity-10 absolute top-[530px] left-[730px] bg-[#FFFFFF] rounded-full border border-black"></div>
